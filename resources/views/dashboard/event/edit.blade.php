...
<input type="hidden" name="event_id" value="{{ $single_event->id }}">
                            ...
                            <textarea name="event_title" id="product_title" class="editable tx-16 bd pd-30 tx-inverse" cols="30" rows="10">{{ $single_event->event_title }}</textarea>

                            <!-- product_details    -->

            			    <textarea name="event_details" id="summernote" cols="30" rows="10">{{ $single_event->event_details }}</textarea>
                            ...
                            <div class="row no-gutters">
            								...
            								<img src="{{ asset('uploads/events') }}/{{ $single_event->photo }}" alt="">
                            ...
                            <div class="row no-gutters">
            								...
            								<label class="custom-file">
                                              <input type="file" id="file" name="photo" class="custom-file-input" value="{{ $single_event->photo }}">
