...
@section('content')
      ...
      <div class="br-mainpanel">
            ...
            <form action="{{ route('gallery_create') }}" method="post" enctype="multipart/form-data">
              @csrf
                            ...
                            <div class="row no-gutters">
                                  ...
                                  <input type="file" id="file" name="gallery" class="custom-file-input">
                            ...
                            <label for="product_title">Gallery Title</label>
        ...
        <div class="col-md-4">
          <a href="{{ asset('uploads/gallery') }}/{{ $gallery->gallery }}" title="My Caption" data-toggle="lightbox" data-gallery="gallery" class="col-md-4">
            <img src="{{ asset('uploads/gallery') }}/{{ $gallery->gallery }}" class="img-fluid rounded">
            <span class="text-center">{{ $gallery->title }}</span>
          </a>
          <div class="text-center">
            <a href="{{ url('/dashboard/gallery') }}/{{ $gallery->id }}" class="btn btn-danger">Delete</a>
          </div>
        </div>
