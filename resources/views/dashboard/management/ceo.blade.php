...
@section('content')
      ...
      <div class="br-mainpanel">
        ...
        <!--               <a class="breadcrumb-item" href="#">Dashboard</a>-->
                   <span class="breadcrumb-item active">CEO NAME</span>
                </nav>
             </div>
        ...
        <div class="pd-x-20 pd-sm-x-30 pd-t-20 pd-sm-t-30">
          <h4 class="tx-gray-800 mg-b-5">CEO</h4>
        </div>
        ...
        <div class="br-pagebody">
          <div class="br-section-wrapper">
            ...
            <form action="{{ route('ceo_create') }}" method="post" enctype="multipart/form-data">
@csrf
                            <!--add product name-->
                            ...
                            <label for="product_title">CEO Long Photo</label>
                            ...
                            <label for="product_title">CEO Signature</label>
                            ...
                            <label for="product_title">CEO QR Code</label>
