...
@section('content')
      ...
      <div class="br-mainpanel">
        ...
        <!--               <a class="breadcrumb-item" href="#">Dashboard</a>-->
                   <span class="breadcrumb-item active">MANAGEMENT COMMITEE</span>
                </nav>
             </div>
        ...
        <div class="pd-x-20 pd-sm-x-30 pd-t-20 pd-sm-t-30">
          <h4 class="tx-gray-800 mg-b-5">MANAGEMENT COMMITEE</h4>
        </div>
          ...
          <div class="br-section-wrapper">
            ...
            <!-- All Logo -->
                ...
                @foreach ($management_commitees as $management_commitee)
                  ...
                  <div class="col-md-4">
                      <div class="card">
                                   <img class="card-img-top img-fluid" src="{{ asset('uploads/management') }}/{{ $management_commitee->photo }}" alt="{{ $management_commitee->name }}">
                                   <div class="card-body">
                                     <h5 class="card-title">{!! html_entity_decode($management_commitee->name) !!}</h5>

                                     <a href="{{ url('/dashboard/management/edit') }}/{{ $management_commitee->id }}" class="btn btn-oblong btn-teal">Edit</a>


                                     <a href="{{ url('/dashboard/management/delete') }}/{{ $management_commitee->id }}" class="btn btn-oblong btn-danger">Remove</a>
                                   </div>
                                 </div>
                         <!-- card -->
                  </div>
