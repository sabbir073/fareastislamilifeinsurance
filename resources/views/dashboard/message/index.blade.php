...
{{ error_reporting(0) }}
      ...
      <div class="br-mainpanel">
        ...
        <!--               <a class="breadcrumb-item" href="#">Dashboard</a>-->
                   <span class="breadcrumb-item active">ADD MESSAGE</span>
                </nav>
             </div>
        ...
        <div class="pd-x-20 pd-sm-x-30 pd-t-20 pd-sm-t-30">
          <h4 class="tx-gray-800 mg-b-5">ADD MESSAGE</h4>
        </div>
        ...
        <div class="br-pagebody">
          <div class="br-section-wrapper">
            ...
            <form action="{{ route('message_create') }}" method="post" enctype="multipart/form-data">
              @csrf
                            <!--title-->
                            ...
                            <textarea name="designation" id="designation" class="editable tx-16 bd pd-30 tx-inverse" cols="30" rows="10"></textarea>
