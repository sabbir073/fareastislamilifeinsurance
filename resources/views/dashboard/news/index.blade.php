          ...
          <div class="br-section-wrapper">
            ...
            <form action="{{ route('news_create') }}" method="post" enctype="multipart/form-data">
                @csrf
                            ...
                            <textarea name="news_title" id="event_title" class="editable tx-16 bd pd-30 tx-inverse" cols="30" rows="10"></textarea>

                            <!-- product_details    -->

            			    <textarea name="news_details" id="summernote" cols="30" rows="10"></textarea>
