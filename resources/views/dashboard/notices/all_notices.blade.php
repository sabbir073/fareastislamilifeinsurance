...
@section('content')
      ...
      <div class="br-mainpanel">
        ...
        <!--               <a class="breadcrumb-item" href="#">Dashboard</a>-->
                   <span class="breadcrumb-item active">ALL NOTICES</span>
                </nav>
             </div>
        ...
        <div class="pd-x-20 pd-sm-x-30 pd-t-20 pd-sm-t-30">
          <h4 class="tx-gray-800 mg-b-5">ALL NOTICES</h4>
        </div>
						...
						<table id="datatable1" class="table display responsive nowrap">
							<thead>
								<tr>
									...
									<th class="wd-20p">Notice Details</th>
							...
							<tbody>
									...
									@foreach ($notices as $notice)
										...
										<tr>
											<td>{{ $notice->id }}</td>
											<td>{!! html_entity_decode(Str::limit($notice->notice_title,25)) !!}</td>
											<td>{!! html_entity_decode(Str::limit($notice->notice_details,25)) !!}</td>
											<td>
												<img src="{{ asset('uploads/notices') }}/{{ $notice->photo }}" alt="">
											</td>
											<td>
											...
											<td>
													<div class="btn-group" role="group" aria-label="Basic example">
																							<a type="button" href="{{ url('/dashboard/notice/edit') }}/{{ $notice->id }}" class="btn btn-secondary pd-x-25 active"><i class="icon ion-edit"></i></a>
																							<a type="button" href="{{ url('/dashboard/notice/delete') }}/{{ $notice->id }}" class="btn btn-danger pd-x-25"><i class="icon ion-trash-a"></i></a>
																						</div>
											</td>
										</tr>
