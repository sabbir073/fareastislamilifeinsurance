...
@section('content')
      ...
      <div class="br-mainpanel">
        ...
        <div class="pd-x-20 pd-sm-x-30 pd-t-20 pd-sm-t-30">
          <h4 class="tx-gray-800 mg-b-5">ADD NOTICE</h4>
        </div>
        ...
        <div class="br-pagebody">
          <div class="br-section-wrapper">
            ...
            <form action="{{ route('notice_create') }}" method="post" enctype="multipart/form-data">
@csrf
                            <!--add product name-->

                            <label for="product_title">Notice Title</label>
                            <textarea name="notice_title" id="event_title" class="editable tx-16 bd pd-30 tx-inverse" cols="30" rows="10"></textarea>
